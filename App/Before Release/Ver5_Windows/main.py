...
class Login(wx.Frame):
    ...
    def __init__(self):
        ...
        # 警告表示
        self.label = wx.StaticText(self.panel_login,-1,"",pos=(150,275),size=(125,20))
        self.label.SetForegroundColour((255, 0, 0))


        # パスワード入力フォーム
        self.textctrl_password = wx.TextCtrl(self.panel_login,style=wx.TE_PASSWORD,pos=(150,300),size=(100,20))
        ...
        # ボタン
        self.button_login = wx.Button(self.panel_login,-1,"ログイン",pos=(150,325),size=(100,20))
...
class Help(wx.Frame):
    ...
    def __init__(self):
        ...
        self.statictext_help_para2 = wx.StaticText(self.panel_help_scroll,-1,"あらかじめ設定した理想量を100%として、現在ある在庫の割合を表示している。左のチェックボックスにチェックを入れることで、確認したい物資を表示させることができる。また、理想量の変更や物資の追加および削除はメニューバーからできる。",size=(400,60))
        ...
        self.statictext_help_para4 = wx.StaticText(self.panel_help_scroll,-1,"本日発注しなければならない物資を表示している。これは客数をもとに算出している。あらかじめ設定された客数による",size=(400,50))
...
class Info(wx.Frame):
    ...
    def __init__(self):
        ...
        self.statictext_info_language = wx.StaticText(self.panel_info,-1,"Python3.7.4",style=wx.TE_CENTER)
