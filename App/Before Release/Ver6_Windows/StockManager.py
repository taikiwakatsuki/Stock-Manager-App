...
class Login(wx.Frame):
    ...
    def __init__(self):
        ...
        # 警告表示
        self.label = wx.StaticText(self.panel_login,-1,"",size=(100,20))
...
class Top(wx.Frame):
    ...
    def __init__(self):
        ...
        self.menu_setting.Append(1,"物資の追加")
...
class Add_and_delete(wx.Frame):
    ...
    def __init__(self):
        ...
        super().__init__(None,wx.ID_ANY,"物資の追加")
        ...
        # 追加
        # self.panel_add = wx.Panel(self.notebook,wx.ID_ANY)
        self.panel_add = wx.Panel(self,wx.ID_ANY)
        self.layout_add = wx.BoxSizer(wx.VERTICAL)

        self.tmp1_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.statictext_add = wx.StaticText(self.panel_add,wx.ID_ANY,"追加する物資の情報を入力して下さい",size=(190,20))

        self.tmp2_add = wx.StaticText(self.panel_add,-1,"",size=(10,20))

        self.statictext_add_name = wx.StaticText(self.panel_add,wx.ID_ANY,"物資名",size=(200,20))
        self.textctrl_add_name = wx.TextCtrl(self.panel_add,pos=(100,70),size=(200,20))

        self.tmp3_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.statictext_add_ideal_value = wx.StaticText(self.panel_add,wx.ID_ANY,"理想量",size=(100,20))
        self.textctrl_add_ideal_value = wx.TextCtrl(self.panel_add,pos=(150,90),size=(100,20))

        self.tmp4_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.statictext_add_value = wx.StaticText(self.panel_add,wx.ID_ANY,"現在の量",size=(100,20))
        self.textctrl_add_value = wx.TextCtrl(self.panel_add,pos=(150,120),size=(100,20))

        self.tmp5_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.statictext_add_criterion_number_of_customers = wx.StaticText(self.panel_add,wx.ID_ANY,"1在庫を消費する客数",size=(110,20))
        self.textctrl_add_criterion_number_of_customers = wx.TextCtrl(self.panel_add,pos=(145,150),size=(100,20))

        self.tmp6_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.label_add = wx.StaticText(self.panel_add,wx.ID_ANY,"",pos=(155,180),size=(120,20))
        self.label_add.SetForegroundColour((255, 0, 0))

        self.button_add = wx.Button(self.panel_add,-1,"追加",size=(100,20))
        self.button_add.SetForegroundColour((0,0,0))
        self.button_add.Bind(wx.EVT_BUTTON,self.clicked_button_add)

        self.tmp7_add = wx.StaticText(self.panel_add,-1,"",size=(10,10))

        self.label_add_complete = wx.StaticText(self.panel_add,wx.ID_ANY,"",size=(60,20))
        self.label_add_complete.SetForegroundColour((255, 0, 0))

        self.layout_add.Add(self.tmp1_add)
        self.layout_add.Add(self.statictext_add,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp2_add)
        self.layout_add.Add(self.statictext_add_name,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.textctrl_add_name,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp3_add)
        self.layout_add.Add(self.statictext_add_ideal_value,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.textctrl_add_ideal_value,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp4_add)
        self.layout_add.Add(self.statictext_add_value,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.textctrl_add_value,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp5_add)
        self.layout_add.Add(self.statictext_add_criterion_number_of_customers,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.textctrl_add_criterion_number_of_customers,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp6_add)
        self.layout_add.Add(self.label_add,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.button_add,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.layout_add.Add(self.tmp7_add)
        self.layout_add.Add(self.label_add_complete,flag=wx.SHAPED | wx.ALIGN_CENTER)
        self.panel_add.SetSizer(self.layout_add)

        # self.notebook.InsertPage(0,self.panel_add, "追加")


        # 削除
        # self.panel_delete = wx.Panel(self.notebook,wx.ID_ANY)
        # self.layout_delete = wx.BoxSizer(wx.VERTICAL)
        #
        # self.tmp1_delete = wx.StaticText(self.panel_delete,-1,"",size=(10,50))
        #
        # for name in names:
        #     element_array.append(str(name))
        # self.combobox = wx.ComboBox(self.panel_delete,wx.ID_ANY,choices=element_array,style=wx.CB_READONLY,size=(300,20))
        #
        # self.tmp2_delete = wx.StaticText(self.panel_delete,-1,"",size=(10,10))
        #
        # self.button_delete = wx.Button(self.panel_delete,-1,"削除",size=(100,20))
        # self.button_delete.SetForegroundColour((0,0,0))
        # self.button_delete.Bind(wx.EVT_BUTTON,self.clicked_button_delete)
        #
        # self.tmp3_delete = wx.StaticText(self.panel_delete,-1,"",size=(10,5))
        #
        # self.label_delete = wx.StaticText(self.panel_delete,-1,"",size=(60,20))
        # self.label_delete.SetForegroundColour((255, 0, 0))
        #
        # self.layout_delete.Add(self.tmp1_delete)
        # self.layout_delete.Add(self.combobox,flag=wx.SHAPED | wx.ALIGN_CENTER)
        # self.layout_delete.Add(self.tmp2_delete)
        # self.layout_delete.Add(self.button_delete,flag=wx.SHAPED | wx.ALIGN_CENTER)
        # self.layout_delete.Add(self.tmp3_delete)
        # self.layout_delete.Add(self.label_delete,flag=wx.SHAPED | wx.ALIGN_CENTER)
        # self.panel_delete.SetSizer(self.layout_delete)
        #
        # self.notebook.InsertPage(1,self.panel_delete, "削除")
    ...
    # 追加ボタンをクリックした時
    def clicked_button_add(self,event):
        if self.textctrl_add_name.GetValue() == "" or self.textctrl_add_ideal_value.GetValue() == "" or self.textctrl_add_value.GetValue() == " " or self.textctrl_add_criterion_number_of_customers.GetValue() == "":
            self.label_add.SetLabel("未入力の項目があります")
        else:
            self.data_tmp = [self.textctrl_add_name.GetValue(),self.textctrl_add_ideal_value.GetValue(),self.textctrl_add_value.GetValue(),False,self.textctrl_add_criterion_number_of_customers.GetValue(),"","","",100]
            data.loc[len(data)] = self.data_tmp
            data.to_csv("Data.csv")
            self.label_add.SetLabel("")
            self.label_add_complete.SetLabel("追加しました")



    # 削除ボタンをクリックした時
    def clicked_button_delete(self,event):
        counter = 0
        for name in names:
            if name == self.combobox.GetValue():
                self.counts = counter
            counter += 1
        data.drop(self.counts)
        data.to_csv("Data.csv")
        self.label_delete.SetLabel("削除しました")
